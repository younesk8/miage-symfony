 ...
 */
final class Version20210313154732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__mention AS SELECT id, diplome_id, nom FROM mention');
        ...
        $this->addSql('INSERT INTO mention (id, diplome_id, nom) SELECT id, diplome_id, nom FROM __temp__mention');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__module AS SELECT id, ue_id, nom, as_obligatoire, ects FROM module');
        ...
        $this->addSql('INSERT INTO module (id, ue_id, nom, as_obligatoire, ects) SELECT id, ue_id, nom, as_obligatoire, ects FROM __temp__module');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__promotion AS SELECT id, mention_id, annee_id, parcours_id, annee_scolaire FROM promotion');
        $this->addSql('DROP TABLE promotion');
        $this->addSql('CREATE TABLE promotion (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, mention_id INTEGER DEFAULT NULL, annee_id INTEGER NOT NULL, parcours_id INTEGER DEFAULT NULL, annee_scolaire VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_C11D7DD17A4147F0 FOREIGN KEY (mention_id) REFERENCES mention (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C11D7DD1543EC5F0 FOREIGN KEY (annee_id) REFERENCES annee (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C11D7DD16E38C0DB FOREIGN KEY (parcours_id) REFERENCES parcours (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO promotion (id, mention_id, annee_id, parcours_id, annee_scolaire) SELECT id, mention_id, annee_id, parcours_id, annee_scolaire FROM __temp__promotion');
        ...
        $this->addSql('DROP INDEX IDX_71688FBC7A4147F0');
        $this->addSql('DROP INDEX IDX_71688FBC543EC5F0');
        $this->addSql('CREATE TEMPORARY TABLE __temp__semestre AS SELECT id, annee_id, mention_id, nom FROM semestre');
        ...
        $this->addSql('INSERT INTO semestre (id, annee_id, parcours_id, nom) SELECT id, annee_id, mention_id, nom FROM __temp__semestre');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE description_diplome (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, mention_id INTEGER DEFAULT NULL, description_bref CLOB NOT NULL COLLATE BINARY, public_concerne CLOB NOT NULL COLLATE BINARY, fiche_pdf VARCHAR(255) NOT NULL COLLATE BINARY, pre_requis CLOB NOT NULL COLLATE BINARY, modalite_inscription CLOB NOT NULL COLLATE BINARY, tarif CLOB NOT NULL COLLATE BINARY, competences CLOB NOT NULL COLLATE BINARY, poursuite_etude CLOB NOT NULL COLLATE BINARY, deboucher_pro CLOB NOT NULL COLLATE BINARY, contact CLOB NOT NULL COLLATE BINARY, atouts CLOB NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__parcours AS SELECT id, mention_id, description_id, nom FROM parcours');
        $this->addSql('DROP TABLE parcours');
        $this->addSql('CREATE TABLE parcours (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, description_id INTEGER DEFAULT NULL, mention_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, CONSTRAINT FK_99B1DEE3D9F966B FOREIGN KEY (description_id) REFERENCES description (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO parcours (id, mention_id, description_id, nom) SELECT id, mention_id, description_id, nom FROM __temp__parcours');
        $this->addSql('DROP TABLE __temp__parcours');
        $this->addSql('CREATE INDEX IDX_99B1DEE37A4147F0 ON parcours (mention_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_99B1DEE3D9F966B ON parcours (description_id)');
        ...
        $this->addSql('DROP TABLE semestre');
        $this->addSql('CREATE TABLE semestre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, annee_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, mention_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO semestre (id, annee_id, mention_id, nom) SELECT id, annee_id, parcours_id, nom FROM __temp__semestre');
        $this->addSql('DROP TABLE __temp__semestre');
        $this->addSql('CREATE INDEX IDX_71688FBC543EC5F0 ON semestre (annee_id)');
